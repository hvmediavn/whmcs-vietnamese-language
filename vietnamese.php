...
$_LANG['affiliatesfootertext'] = "- Khách hàng bạn giới thiệu phải sử dụng dịch vụ ít nhất 1 tháng, và phần lợi nhuận bạn sẽ được ghi vào tài khoản của bạn và được thanh toán vào cuối tháng (tính từ lúc khách hàng của bạn đăng ký sử dụng dịch vụ của Tiếp).<br/><br/>- Chương trình chia sẽ doanh thu là một chương trình hợp tác giữa bạn và Tiếp đôi bên cùng có lợi, bạn giới thiệu thêm khách hàng cho Tiếp, Tiếp sẽ chia sẽ lợi nhuận lại cho bạn. Vì vậy tất cả các giới thiệu không đem lại doanh thu cũng như lợi nhuận cho Tiếp, Tiếp sẽ không chia sẽ lại doanh thu cho bạn.<br/><br/>- Với các dịch vụ “Thuê Server riêng”, “Thuê chỗ đặt Server”, “Thiết kế website” có thể chấp nhận giới thiệu không thông qua link giới thiệu, ngoài ra tất cả các dịch vụ khác phải được giới thiệu trực tuyến trên Internet qua link giới thiệu do Tiếp cung cấp.<br/><br/>- Số tiền hoa hồng trong tài khoản của bạn có thể dùng để thanh toán dịch vụ của Tiếp, hoặc có thể rút ra bằng tiền mặt.<br/><br/>- Số tiền hoa hồng của bạn phải từ 500,000 VNĐ trở lên bạn mới có thể rút ra hoặc sử dụng.<br/><br/>- Giới thiệu link chia sẻ doanh thu của bạn lên các diễn đàn, blog, hay trang web của riêng bạn dưới dạng liên kết hoặc banner, chúng tôi không ủng hộ hình thức spam, việc chia sẻ doanh thu chấm dứt nếu bạn spam làm ảnh hưởng đến uy tín của Tiếp. Không chấp nhận việc tự giới thiệu cho bản thân.";
$_LANG['affiliateshostingpackage'] = "Gói Hosting";
$_LANG['affiliatesintrotext'] = "Bạn đang hoạt động và kinh doanh trong lĩnh vực Web, dịch vụ mạng và dịch vụ trực tuyến, bạn là sinh viên, học sinh … Bạn muốn kiếm tiền trên Internet? Hãy tham gia chương trình chia sẻ doanh thu trực tuyến cùng Tiếp.";
$_LANG['affiliateslinktous'] = "Liên kết tới Tiếp";
...
$_LANG['affiliatesreferallink'] = "Giới thiệu của bạn nhận ngay 20% khi đơn hàng được thanh toán";
...
$_LANG['cartnameserversdesc'] = "Nếu quý khách không muốn quản lý DNS tại Tiếp, hãy nhập Nameserver của dịch vụ DNS của quý khách vào bên dưới.";
...
$_LANG['clientareacancelproduct'] = "Yêu cầu hủy dịch vụ";
...
$_LANG['clientareaemails'] = "Thông tin tài khoản hosting";
...
$_LANG['clientareaerrorstate'] = "Bạn chưa nhập vùng (Quận huyện)";
...
$_LANG['domainbulktransfersearch'] = "Chuyển nhiều tên miền về Tiếp";
...
$_LANG['domainregnotavailable'] = "Đã có người đăng ký miền này";
...
$_LANG['forwardingtogateway'] = "Chúng tôi đang chuyển hướng bạn đến khu vực thanh toán của nhà thanh toán của bạn xin vui lòng đợi giây lát...";
$_LANG['globalsystemname'] = "Đăng ký tên miền và mua hosting";
...
$_LANG['invoiceaddcreditamount'] = "Vui lòng nhập số tiền muốn thanh toán";
$_LANG['invoiceaddcreditapply'] = "Sử dụng tài khoản trả trước";
$_LANG['invoiceaddcreditdesc1'] = "Số Tiền";
...
$_LANG['knowledgebasetitle'] = "Hỗ trợ";
...
$_LANG['loginrememberme'] = "Lưu thông tin";
...
$_LANG['orderconfigure'] = "Tùy chỉnh theo nhu cầu";
...
$_LANG['ordererrordomainalreadyexists'] = "Tên miền này đã được đăng ký thành công bên Tiếp. Xin hãy đăng nhập để quản lý tên miền của bạn";
...
$_LANG['orderpaymenttermTiếpime'] = "Thanh toán 1 lần";
...
$_LANG['orderreceived'] = "Cám ơn quý khách đã đăng ký sử dụng dịch vụ tại Tiếp. Thông tin xác nhận đơn đặt hàng sẽ được gửi đến email của quý khách.";
...
$_LANG['transferdomaindesc'] = "Vui lòng nhập tên miền quý khách muốn chuyển về Tiếp vào ô dưới đây.";
...
$_LANG['vpsnethourly'] = "mỗi giờ";
$_LANG['vpsnetdaily'] = "mỗi ngày";
$_LANG['vpsnetweekly'] = "mỗi tuần";
$_LANG['vpsnetmonthly'] = "mỗi tháng";
$_LANG['view'] = "Xem";
...
$_LANG['carttransferpossible'] = "Quý khách có thể chuyển quản lý tên miền %s về Tiếp chỉ với %s";
...
$_LANG['cartregisterdomainchoice'] = "Đăng ký tên miền mới tại Tiếp";
$_LANG['carttransferdomainchoice'] = "Chuyển tên miền về Tiếp";
...
$_LANG['navemailssent'] = "Thông tin tài khoản hosting";

$_LANG['edit'] = "Chỉnh sửa";
$_LANG['thankYou'] = "Cảm ơn";
$_LANG['na'] = "chưa hỗ trợ";
...
$_LANG['emailviewmessage'] = "Xem chi tiết";
...
$_LANG['clientareahomelogin'] = "Đăng nhập hoặc lấy lại mật khẩu nếu bạn đã quên mật khẩu";
$_LANG['clientareahomeorderbtn'] = "Đăng ký dịch vụ";
$_LANG['clientareahomeloginbtn'] = "Đăng nhập";

$_LANG['clientareaproductsintro'] = "Danh sách các dịch vụ bạn đã đăng ký tại Tiếp.";
$_LANG['clientareaproductdetailsintro'] = "Thông tin chi tiết về các sản phẩm / dịch vụ của bạn đã đăng ký.";
$_LANG['clientareadomainsintro'] = "Danh sách các tên miền bạn đã đăng ký tại Tiếp.";
$_LANG['invoicesintro'] = "Danh sách các hóa đơn dịch vụ đã đăng ký tại Tiếp.";
...
$_LANG['domaincheckerdomainexample'] = " ví dụ: miền của bạn.com";
...
$_LANG['feedbackthankyou'] = "Tiếp xin chân thành cảm ơn quý khách đã dành thời gian hoàn tất bản khảo sát. Mọi ý kiến đóng góp của quý khách có ý nghĩa rất lớn với chúng tôi.";
$_LANG['feedbackreceived'] = "Ý kiến đánh giá / đóng góp đã được gửi";
$_LANG['feedbackdesc'] = "Với mong muốn không ngừng nâng cao chất lượng dịch vụ để phục vụ khách hàng ngày càng tốt hơn, Tiếp rất mong nhận được các ý kiến đánh giá / đóng góp quý báu của quý khách.";
...
$_LANG['feedbackimprove'] = "Ý kiến đóng góp riêng của Quý khách để Tiếp ngày càng phát triển.";
...
$_LANG['sidebars']['viewAccount']['emailHistory'] = "Thông tin tài khoản hosting";
...
$_LANG['homebegin'] = "Tìm kiếm và tra cứu tên miền";
$_LANG['howcanwehelp'] = "Tiếp giúp bạn";
$_LANG['exampledomain'] = "ví dụ: miền của bạn.com";
...
$_LANG['news'] = "Tin khuyến mãi";
$_LANG['allthelatest'] = "Cập nhật thông tin mới nhất từ";
$_LANG['readmore'] = "Đọc thêm";
$_LANG['noannouncements'] = "chưa có tin khuyến mãi nào";

$_LANG['generatePassword']['btnLabel'] = "khởi tạo mật khẩu";
$_LANG['generatePassword']['btnShort'] = "Khởi tạo";
$_LANG['generatePassword']['title'] = "khởi tạo mật khẩu";
$_LANG['generatePassword']['lengthValidationError'] = "Mật khẩu phải từ 8 đến 64 ký tự";
$_LANG['generatePassword']['pwLength'] = "Độ mạnh của mật khẩu";
$_LANG['generatePassword']['generatedPw'] = "khởi tạo mật khẩu";
$_LANG['generatePassword']['generateNew'] = "tạo mật khẩu mới";
$_LANG['generatePassword']['copyAndInsert'] = "Copy và tự động điền";
...
$_LANG['error'] = "Lỗi";
$_LANG['print'] = "In hóa đơn";
$_LANG['invoicelineitems'] = "Chi tiết đơn hàng";
...
# Custom Phrases
$_LANG['wiretransfer_instruction'] = "<a href=\"https://tiep.vn/ho-tro/hinh-thuc-thanh-toan/\"><img src=\"https://tiep.vn/images/huong-dan-thanh-toan.png\"></a>";
...
$_LANG['dateTime']['thursday'] = "Thứ năm";
$_LANG['dateTime']['friday'] = "Thứ sáu";
$_LANG['dateTime']['saturday'] = "Thứ bảy";
$_LANG['dateTime']['sunday'] = "Chủ nhật";
$_LANG['dateTime']['mon'] = "T2";
$_LANG['dateTime']['tue'] = "T3";
$_LANG['dateTime']['wed'] = "T4";
$_LANG['dateTime']['thu'] = "T5";
$_LANG['dateTime']['fri'] = "T6";
$_LANG['dateTime']['sat'] = "T7";
$_LANG['dateTime']['sun'] = "CN";
$_LANG['dateTime']['th'] = "th";
$_LANG['dateTime']['nd'] = "nd";
$_LANG['dateTime']['rd'] = "rd";
$_LANG['dateTime']['st'] = "st";
$_LANG['dateTime']['january'] = "Tháng 1";
$_LANG['dateTime']['february'] = "Tháng 2";
$_LANG['dateTime']['march'] = "Tháng 3";
$_LANG['dateTime']['april'] = "Tháng 4";
$_LANG['dateTime']['may'] = "Tháng 5";
$_LANG['dateTime']['june'] = "Tháng 6";
$_LANG['dateTime']['july'] = "Tháng 7";
$_LANG['dateTime']['august'] = "Tháng 8";
$_LANG['dateTime']['september'] = "Tháng 9";
$_LANG['dateTime']['october'] = "Tháng 10";
$_LANG['dateTime']['november'] = "Tháng 11";
...
$_LANG['dateTime']['days'] = "Các ngày";
$_LANG['dateTime']['hour'] = "Giờ";
$_LANG['dateTime']['hours'] = "Các giờ";
$_LANG['dateTime']['minute'] = "Phút";
$_LANG['dateTime']['minutes'] = "Các phút";

$_LANG['emailMarketing']['joinOurMailingList'] = "Đăng ký nhận tin khuyến mãi";

$_LANG['getStartedNow'] = "Đặt mua ngay";

$_LANG['startingat'] = "Hãy bắt đầu với";

$_LANG['cloudSlider']['feature01Title'] = "Server Uptime lên tới 99,99% thời gian";
$_LANG['cloudSlider']['feature01Description'] = "Thời gian hoạt động của máy chủ rất quan trọng đối với tất cả các doanh nghiệp - hãy coi đó là nhịp tim của việc lưu trữ doanh nghiệp của bạn. Máy chủ tệp và cơ sở dữ liệu, máy chủ email và web là một phần không thể thiếu trong hầu hết các quy trình kinh doanh và thời gian ngừng hoạt động có ảnh hưởng tiêu cực trực tiếp đến năng suất, doanh số bán hàng, sự hài lòng của nhân viên và khách hàng. Đó là lý do tại sao việc đảm bảo thời gian hoạt động tối đa của máy chủ rất quan trọng đối với chúng tôi - chúng tôi muốn đảm bảo các quy trình kinh doanh của bạn đang hoạt động tốt để khách hàng của bạn hài lòng.";
$_LANG['cloudSlider']['feature01DescriptionTwo'] = "Bằng cách tin tưởng chúng tôi đáp ứng nhu cầu kinh doanh của bạn, chúng tôi cam kết với bạn 99,9% thời gian hoạt động đối với bất kỳ dịch vụ nào chúng tôi cung cấp, ngoài bất kỳ bảo trì tiêu chuẩn nào mà chúng tôi có thể cung cấp.";
$_LANG['cloudSlider']['feature02Title'] = "Truy cập ở bất cứ đâu trên toàn thế giới";
$_LANG['cloudSlider']['feature02Description'] = "Dịch vụ của chúng tôi được cung cấp bởi hàng trăm máy chủ và trung tâm dữ liệu được đặt trên toàn thế giới, vì vậy bạn có thể yên tâm khi biết rằng khách hàng có thể truy cập trang web của bạn từ mọi nơi. Ngoài ra, chúng tôi cung cấp các công cụ giám sát để cung cấp cho bạn phân tích chuyên gia - lưu lượng truy cập trang web là một bước quan trọng trong việc cải thiện hiệu quả và mức độ phổ biến của trang web của bạn, cũng như theo dõi khách truy cập đến từ đâu, họ ghé thăm bạn vào thời gian nào trong ngày và họ sẽ ở lại trong bao lâu. Sự cống hiến của chúng tôi đối với thị trường toàn cầu mở rộng đến đăng ký miền, vì chúng tôi cung cấp TLD phổ biến nhất để đăng ký.";
$_LANG['cloudSlider']['feature02DescriptionTwo'] = "Sự tận tâm của chúng tôi đối với việc hỗ trợ khách hàng cũng tiếp cận trên toàn cầu. Chúng tôi sẵn sàng trợ giúp bạn về dịch vụ lưu trữ của bạn theo bất kỳ cách nào có thể và bạn có thể liên hệ với chúng tôi qua điện thoại, email hoặc trò chuyện trực tiếp.";
$_LANG['cloudSlider']['feature03Title'] = "Bảo mật & ẩn danh";
$_LANG['cloudSlider']['feature03Description'] = "Hãy yên tâm khi biết rằng chúng tôi cung cấp tính năng giám sát an ninh 24/7 và bảo vệ DDoS. Bạn coi trọng việc bảo vệ dữ liệu của khách hàng và chúng tôi cũng vậy. Đội ngũ bảo mật và các biện pháp bảo vệ của chúng tôi làm việc cả ngày, hàng ngày để cung cấp mức độ bảo mật cần thiết trong thời đại kỹ thuật số ngày nay.";
$_LANG['cloudSlider']['feature03DescriptionTwo'] = "Bạn có thể sử dụng một loạt các công cụ bảo mật, bao gồm chứng chỉ SSL, cấu hình tường lửa, dịch vụ giám sát bảo mật, truy cập VPN, v.v.";
$_LANG['cloudSlider']['selectProductLevel'] = "Lựa chọn gói hosting phù hợp với bạn";
...
$_LANG['orderForm']['year'] = "chỉ 1 năm";
$_LANG['orderForm']['years'] = "Nhiều năm";
$_LANG['orderForm']['domainOrKeyword'] = "Nhập tên miền hoặc từ khóa";
$_LANG['orderForm']['searching'] = "Đang tìm kiếm và kiểm tra";
$_LANG['orderForm']['domainIsUnavailable'] = "<strong>:domain</strong> Đã được đăng ký"; //Strong tag is required here
$_LANG['orderForm']['add'] = "Đăng ký";
$_LANG['orderForm']['suggestedDomains'] = "Tên miền gợi ý cho bạn";
$_LANG['orderForm']['generatingSuggestions'] = "Những gợi ý dành cho bạn";
...
$_LANG['orderForm']['packagesForBudget'] = "Đăng ký hosting thanh toán 1 năm miễn phí ngay với tên miền .com";
$_LANG['orderForm']['exploreNow'] = "Đăng ký hosting";
$_LANG['orderForm']['transferToUs'] = "Chuyển tên miền về Tiếp";
$_LANG['orderForm']['transferExtend'] = "Miễn phí chuyển tên miền về Tiếp";
$_LANG['orderForm']['transferDomain'] = "Chuyển tên miền ";
$_LANG['orderForm']['extendExclusions'] = "Miễn phí Hosting 1GB dung lượng khi chuyển về Tiếp";
...
$_LANG['domainCheckerSalesGroup']['sale'] = "Giảm giá";
...
$_LANG['pricing']['register'] = "Giá đăng ký mới";
$_LANG['pricing']['transfer'] = "Chuyển miền";
$_LANG['pricing']['renewal'] = "Gia hạn";
$_LANG['pricing']['selectExtCategory'] = "Please choose a category from above.";

$_LANG['navStore'] = "Dịch Vụ";
$_LANG['navBrowseProductsServices'] = "Xem toàn bộ dịch vụ";

$_LANG['navWebsiteSecurity'] = "Website & bảo mật";
$_LANG['navMarketConnectService']['symantec'] = "Chứng nhận SSL https";
$_LANG['navMarketConnectService']['weebly'] = "Công cụ dựng web";
$_LANG['navMarketConnectService']['spamexperts'] = "Dịch vụ máy chủ E-mail";
...
$_LANG['from'] = "Từ";
$_LANG['orderForm']['findNewDomain'] = "Tìm tên miền. Nhập tên miền bạn cần tra cứu bên dưới.";
$_LANG['orderForm']['transferExistingDomain'] = "Chuyển tên miền của bạn về Tiếp.";
$_LANG['orderForm']['www'] = "www.";
$_LANG['orderForm']['check'] = "Kiểm tra";
$_LANG['orderForm']['returnToClientArea'] = "Quay trở lại trang quản trị";
...
$_LANG['orderForm']['correctErrors'] = "Xin hãy nhập đầy đủ thông tin như yêu cầu này nha, trước khi tiếp tục";
$_LANG['orderForm']['existingCustomerLogin'] = "Nếu đã là khách hàng, hãy đăng nhập";
...
$_LANG['orderForm']['optional'] = "nếu có";
$_LANG['orderForm']['streetAddress'] = "Số nhà hoặc tên đường";
$_LANG['orderForm']['streetAddress2'] = "địa chỉ phụ";
$_LANG['orderForm']['city'] = "Quận/Huyện";
$_LANG['orderForm']['state'] = "Thành Phố";
$_LANG['orderForm']['country'] = "Quốc gia";
$_LANG['orderForm']['postcode'] = "Mã bưu chính";
$_LANG['orderForm']['domainAlternativeContact'] = "Bạn có thể điền thông tin quản lý tên miền khác với thông tin cá nhân địa chỉ của bạn. ví dụ như là đăng ký trên danh nghĩa bạn bè, công ty thì có thể tạo riêng thông tin bằng cách bấm vào bên dưới. Nếu không hãy bỏ qua phần này";
$_LANG['orderForm']['accountSecurity'] = "Bảo mật tài khoản";
$_LANG['orderForm']['mediumStrength'] = "Độ dài trung bình";
$_LANG['orderForm']['paymentDetails'] = "Thông tin thanh toán";
$_LANG['orderForm']['preferredPaymentMethod'] = "Xin lựa chọn phương thức thanh toán.";
$_LANG['orderForm']['cardNumber'] = "Thông tin thẻ";
$_LANG['orderForm']['cvv'] = "3 số CVV bí mật";
$_LANG['orderForm']['additionalNotes'] = "Nội dung ghi chú";
$_LANG['orderForm']['continueToClientArea'] = "Tiếp tục đến trang quản trị";
$_LANG['orderForm']['reviewDomainAndAddons'] = "Xin hãy xem xét các tên miền đã lựa chọn và chọn thêm dịch vụ bổ sung nếu muốn.";
$_LANG['orderForm']['addToCart'] = "Đưa vào giỏ hàng";
...
$_LANG['orderForm']['haveQuestionsClickHere'] = "Bấm vào đây";
$_LANG['orderForm']['use'] = "Đăng Ký";
$_LANG['orderForm']['check'] = "Kiểm tra";
$_LANG['orderForm']['transfer'] = "Chuyển Về";
$_LANG['orderForm']['domainAddedToCart'] = "Tên miền này đã có trong giỏ hàng của bạn.";
...
$_LANG['orderForm']['submitTicket'] = "Gửi một ticket vé hỗ trợ";
$_LANG['orderForm']['promotionAccepted'] = "Mã giảm giá đã được xác nhận thành công! Số tiền đã được cập nhật.";
...
$_LANG['orderForm']['remove'] = "Gỡ bỏ";
$_LANG['orderForm']['applyPromoCode'] = "nhập mã giảm giá";
$_LANG['orderForm']['estimateTaxes'] = "Estimate Taxes";
$_LANG['orderForm']['removePromotionCode'] = "gỡ bỏ mã giảm giá";
$_LANG['orderForm']['updateTotals'] = "cập nhật tổng tiền";
$_LANG['orderForm']['continueShopping'] = "Đặt thêm dịch vụ";
$_LANG['orderForm']['removeItem'] = "Xóa dịch vụ";
$_LANG['orderForm']['yes'] = "Vâng ạ";
$_LANG['orderForm']['cancel'] = "Hủy bỏ";
$_LANG['orderForm']['close'] = "Close";
$_LANG['orderForm']['totals'] = "Totals";
$_LANG['orderForm']['includedWithPlans'] = "Đi kèm với mỗi gói sản phẩm";
$_LANG['orderForm']['whatIsIncluded'] = "Có gì kèm theo không?";
...
/////////// pricing theo ngay thang nam 
$_LANG['pricingCycleShort']['monthly'] = "Tháng";
$_LANG['pricingCycleShort']['quarterly'] = "3 tháng";
$_LANG['pricingCycleShort']['semiannually'] = "6 tháng";
$_LANG['pricingCycleShort']['annually'] = "hàng năm";
$_LANG['pricingCycleShort']['biennially'] = "mỗi 2 năm";
$_LANG['pricingCycleShort']['triennially'] = "mỗi 3 năm";
$_LANG['pricingCycleLong']['monthly'] = "phí hàng tháng";
$_LANG['pricingCycleLong']['quarterly'] = "phí 3 tháng";
$_LANG['pricingCycleLong']['semiannually'] = "phí 6 tháng";
$_LANG['pricingCycleLong']['annually'] = "1 năm";
$_LANG['pricingCycleLong']['biennially'] = "2 năm";
$_LANG['pricingCycleLong']['triennially'] = "3 năm";