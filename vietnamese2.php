...
$_LANG['addfundsamount'] = "Số tiền nạp";
...
$_LANG['affiliatesactivate'] = "Kích hoạt tài khoản cộng tác viên";
$_LANG['affiliatesamount'] = "Số dư";
$_LANG['affiliatesbalance'] = "Số dư hiện tại";
$_LANG['affiliatesbullet1'] = "Nhận một khoản hoa hồng theo phần trăm cộng vào số dư của bạn";
$_LANG['affiliatesbullet2'] = "Khi mỗi khách hàng bạn giới thiệu chúng tôi đặt mua dịch vụ trên hệ thống";
$_LANG['affiliatescommission'] = "Hoa hồng";
$_LANG['affiliatesdescription'] = "Tham gia cộng tác viên với chúng tôi và hưởng hoa hồng môi giới";
...
$_LANG['affiliatesfootertext'] = "- Khách hàng bạn giới thiệu phải sử dụng dịch vụ ít nhất 1 tháng, và phần lợi nhuận bạn sẽ được ghi vào tài khoản của bạn và được thanh toán vào cuối tháng (tính từ lúc khách hàng của bạn đăng ký sử dụng dịch vụ của chúng tôi).<br/><br/>- Chương trình chia sẽ doanh thu là một chương trình hợp tác giữa bạn và chúng tôi đôi bên cùng có lợi, bạn giới thiệu thêm khách hàng cho chúng tôi, chúng tôi sẽ chia sẽ lợi nhuận lại cho bạn. Vì vậy tất cả các giới thiệu không đem lại doanh thu cũng như lợi nhuận cho chúng tôi, chúng tôi sẽ không chia sẽ lại doanh thu cho bạn.<br/><br/>- Với các dịch vụ “Thuê Server riêng”, “Thuê chỗ đặt Server”, “Thiết kế website” có thể chấp nhận giới thiệu không thông qua link giới thiệu, ngoài ra tất cả các dịch vụ khác phải được giới thiệu trực tuyến trên Internet qua link giới thiệu do chúng tôi cung cấp.<br/><br/>- Số tiền hoa hồng trong tài khoản của bạn có thể dùng để thanh toán dịch vụ của chúng tôi, hoặc có thể rút ra bằng tiền mặt.<br/><br/>- Số tiền hoa hồng của bạn phải từ 500,000 VNĐ trở lên bạn mới có thể rút ra hoặc sử dụng.<br/><br/>- Giới thiệu link chia sẻ doanh thu của bạn lên các diễn đàn, blog, hay trang web của riêng bạn dưới dạng liên kết hoặc banner, chúng tôi không ủng hộ hình thức spam, việc chia sẻ doanh thu chấm dứt nếu bạn spam làm ảnh hưởng đến uy tín của chúng tôi. Không chấp nhận việc tự giới thiệu cho bản thân.";
$_LANG['affiliateshostingpackage'] = "Gói Hosting";
$_LANG['affiliatesintrotext'] = "Bạn đang hoạt động và kinh doanh trong lĩnh vực Web, dịch vụ mạng và dịch vụ trực tuyến, bạn là sinh viên, học sinh … Bạn muốn kiếm tiền trên Internet? Hãy tham gia chương trình chia sẻ doanh thu trực tuyến cùng chúng tôi:";
$_LANG['affiliateslinktous'] = "Liên kết với chúng tôi";
$_LANG['affiliatesnosignups'] = "Bạn hiện chưa giới thiệu được khách hàng nào";
$_LANG['affiliatesrealtime'] = "Thông tin thống kê sẽ được cập nhật ngay lập tức khi có sự thay đổi";
$_LANG['affiliatesreferallink'] = "Liên kết link giới thiệu của riêng bạn";
$_LANG['affiliatesreferals'] = "Những lượt môi giới, giới thiệu của bạn";
$_LANG['affiliatesregdate'] = "Ngày đăng ký";
$_LANG['affiliatesrequestwithdrawal'] = "Gửi yêu cầu thanh toán";
$_LANG['affiliatessignupdate'] = "Đăng ký ngày";
$_LANG['affiliatesstatus'] = "Tình trạng";
$_LANG['affiliatestitle'] = "Môi giới";
$_LANG['affiliatesvisitorsreferred'] = "Số lượng truy cập đã bấm vào link liên kết giới thiệu";
$_LANG['affiliateswithdrawalrequestsuccessful'] = "Yêu cầu thanh toán tiền hoa hồng của bạn đã được gửi tới kế toán. Chúng tôi sẽ liên hệ lại với bạn trong thời gian sớm nhất.";
$_LANG['affiliatesWithdrawalRequestUnsuccessful'] = "Yêu cầu thanh toán hoa hồng không thành công. Xin hãy thử lại sau ít phút.";
...
$_LANG['announcementscontinue'] = "Đọc tiếp";
$_LANG['bannedbanexpires'] = "Bị khóa sẽ hết hạn";
$_LANG['bannedbanreason'] = "Lý do bị khóa";
$_LANG['bannedhasbeenbanned'] = "Bạn đã bị khóa";
$_LANG['bannedtitle'] = "Địa chỉ IP đã bị khóa";
$_LANG['bannedyourip'] = "Địa chỉ IP của bạn";
$_LANG['cartaddons'] = "Tiện ích mở rộng";
$_LANG['cartbrowse'] = "Xem Sản phẩm &amp; các Dịch vụ";
$_LANG['cartconfigdomainextras'] = "Cấu hình dịch vụ thêm cho tên miền";
$_LANG['cartconfigoptionsdesc'] = "Sản phẩm hoặc dịch vụ này có nhiều lựa chọn thêm mở rộng mà bạn có thể lựa chọn bên dưới theo nhu cầu sở thích của bạn.";
...
$_LANG['cartdomainshashosting'] = "Bạn đã có hosting";
$_LANG['cartdomainsnohosting'] = "Nếu chưa có host! Bấm vào đây để thêm";
$_LANG['carteditproductconfig'] = "Chỉnh sửa cài đặt cấu hình";
$_LANG['cartempty'] = "Giỏ hàng trống";
$_LANG['cartemptyconfirm'] = "Bạn có chắc là xóa hết mọi thứ trong giỏ hàng của mình?";
$_LANG['cartexistingclientlogin'] = "Đã có tài khoản hãy Đăng nhập";
$_LANG['cartexistingclientlogindesc'] = "Bạn cần đăng nhập để thêm đơn hàng này vào tài khoản của bạn.";
$_LANG['cartnameserversdesc'] = "Nếu quý khách không muốn dùng DNS mặc định của chúng tôi. Hãy nhập Nameserver của dịch vụ DNS của quý khách vào bên dưới.";
...
$_LANG['cartproductdomaindesc'] = "Dịch vụ hoặc sản phẩm mà bạn đã chọn yêu cầu bắt buộc cần có tên miền. Xin hãy nhập tên miền của bạn vào bên dưới.";
$_LANG['cartproductdomainuseincart'] = "Dùng tên miền có sẵn trong giỏ hàng của tôi";
$_LANG['cartremove'] = "Gỡ bỏ";
$_LANG['cartremoveitemconfirm'] = "Xin xác nhận rằng bạn đồng ý gỡ bỏ món hàng ra khỏi giỏ hàng?";
$_LANG['carttaxupdateselections'] = "Thuế VAT có thể được áp dụng tùy thuộc vào Tỉnh, Thành Phố hoặc Quốc gia mà bạn đã chọn. Xin bấm vào Tính tiền thuế sau khi bạn cập nhật các thay đổi.";
...
$_LANG['checkavailability'] = "Kiểm tra khả dụng";
$_LANG['checkout'] = "Thanh toán";
$_LANG['choosecurrency'] = "Chọn đơn vị tiền tệ";
$_LANG['choosedomains'] = "Lựa chọn tên miền";
$_LANG['clickheretologin'] = "Bấm vào đây để đăng nhập";
$_LANG['clientareaaccountaddons'] = "Tài khoản và các bổ sung";
$_LANG['clientareaactive'] = "Đang kich hoạt";
$_LANG['clientareaaddfundsdisabled'] = "Chúng tôi hiện chưa nhận nạp tiền sẵn tại thời điểm này.";
$_LANG['clientareaaddfundsnotallowed'] = "Bạn cần có ít nhất một đơn hàng đang hoạt động hoặc đang kích hoạt thì mới có thể nạp thêm tiền. Vì vậy tác vụ này không thể hoàn thành tại thời điểm hiện tại!";
$_LANG['clientareaaddon'] = "Bổ sung";
$_LANG['clientareaaddonorderconfirmation'] = "Xin cảm ơn. Dịch vụ bổ sung cho đơn hàng của bạn bên dưới đã thực hiện thành công. Xin lựa chọn phương thức thanh toán bên dưới.";
$_LANG['clientareaaddonpricing'] = "Đơn giá";
$_LANG['clientareaaddonsfor'] = "Bổ sung cho";
$_LANG['clientareaaddress1'] = "Địa chỉ chính";
$_LANG['clientareaaddress2'] = "Địa chỉ phụ";
$_LANG['clientareabwlimit'] = "Giới hạn băng thông";
$_LANG['clientareabwusage'] = "Băng thông đã sử dụng";
$_LANG['clientareacancel'] = "Hủy bỏ thay đổi này";
$_LANG['clientareacancelconfirmation'] = "Xin cảm ơn. Yêu cầu hủy bỏ của bạn đã được gửi đi. Nếu bạn thực hiện việc này do nhầm lẫn, xin hãy mở ticket để yêu cầu chúng tôi hành động hỗ trợ hoặc tài khoản của bạn có thể bị hạn chế tạm khóa.";
$_LANG['clientareacancelinvalid'] = "Tài khoản này đã có yêu cầu hủy bỏ gửi đi vì vậy bạn không thể thực hiện gửi thêm yêu cầu khác.";
...
$_LANG['clientareacancelproduct'] = "Yêu cầu hủy dịch vụ cho";
...
$_LANG['copyrightFooterNotice'] = "Bản quyền phát triển &copy; từ 2017 đến :year :company. Quyền lợi, Nghĩa Vụ và Trách nhiệm.";
